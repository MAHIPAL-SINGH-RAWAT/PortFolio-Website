    ...
    <section id="projects" className="bg-gradient-to-br from-gray-50 to-white py-20">
      <div className="mx-auto px-6 max-w-7xl">
        ...
        <div className="mb-20 text-center">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-emerald-500 mx-auto mb-8 rounded-full w-24 h-1.5"></div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-block">
            <button className="group relative bg-gradient-to-r from-blue-600 hover:from-blue-700 via-blue-700 hover:via-blue-800 to-emerald-600 hover:to-emerald-700 shadow-lg hover:shadow-xl px-8 py-4 rounded-2xl overflow-hidden font-semibold text-white hover:scale-105 transition-all duration-300">
